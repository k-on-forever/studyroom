  ...
  <el-form>
    ...
    <el-form-item label="导航条类型">
      <el-radio-group v-model="navbarLayoutType">
        <el-radio label="default" border>浅色（推荐）</el-radio>
        <el-radio label="inverse" border>深色</el-radio>
      </el-radio-group>
    </el-form-item>
    <el-form-item label="侧边栏皮肤">
      <el-radio-group v-model="sidebarLayoutSkin">
        <el-radio label="light" border>浅色</el-radio>
        <el-radio label="dark" border>深色</el-radio>
      </el-radio-group>
    </el-form-item>
  </el-form>
</template>
